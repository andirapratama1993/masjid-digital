...
export default function ActivityView({ settings, activities, isLight, hasImage }: ActivityViewProps) {
  ...
  // Image dimensions from settings (percent of screen)
  ...
  // =============================================
  // DETAIL VIEW: fullscreen image per activity
  // =============================================
  if (mode === 'detail' && allActivities.length > 0) {
    ...
    return (
      <div className="flex flex-col h-full animate-fade-in">
        ...
        {/* Image container — sized by settings */}
        <div
          ...
          >
            {activity.image_url ? (
              ...
              <div
                ...
                style={{ background: isLight ? 'rgba(16,185,129,0.08)' : 'rgba(16,185,129,0.06)' }}
              >
                <p className="text-8xl opacity-20">&#128332;</p>
                <div className="text-center px-6">
                  <p className="text-2xl sm:text-4xl font-bold mb-2" style={{ color: t.title }}>
                    {activity.title}
                  </p>
                  {activity.description && (
                    <p className="text-base sm:text-lg mb-3" style={{ color: t.sub }}>
                      {activity.description}
                    </p>
                  )}
